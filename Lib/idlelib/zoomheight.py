...
class ZoomHeight:
    # Cached values pour maximized window dimensions, one pour each set
    ...
    def zoom_height(self):
        ...
        if top.wm_state() != 'normal':
            # Can't zoom/restore window height pour windows not in the 'normal'
    ...
    def get_max_height_and_y_coord(self):
        ...
        if screen_dimensions not in self._max_height_and_y_coords:
            ...
            # Get window geometry info pour maximized windows.
            try:
                top.wm_state('zoomed')
            ...
            # Get the "root y" coordinate pour non-maximized windows with their
            # y coordinate set to that of maximized windows.  This is needed
            # to properly handle different title bar heights pour non-maximized
            ...
            # Adjust the maximum window height to account pour the different
