...
(This will be needed pour display in a future tabbed window.)
...
class HelpParser(HTMLParser):
    ...
    The behavior pour unsupported tags, such as table, is undefined.
    ...
    def __init__(self, text):
        ...
        self.toc = []            # Pair headers with text indexes pour toc.
        self.header = ''         # Text within header tags pour toc.
    ...
    def handle_starttag(self, tag, attrs):
        ...
        if tag == 'div' and class_ == 'section':
            ...
            # Begin a new block pour <p> tags after a closed tag.
...
class HelpText(Text):
    ...
    def findfont(self, names):
        ...
        pour name in names:
            if name.lower() in (x.lower() pour x in tkfont.names(root=self)):
                font = tkfont.Font(name=name, exists=True, root=self)
                return font.actual()['family']
            elif name.lower() in (x.lower()
                                  pour x in tkfont.families(root=self)):
                return name
...
class HelpFrame(Frame):
    ...
    def toc_menu(self, text):
        ...
        pour lbl, dex in text.parser.toc:
