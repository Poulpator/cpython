...
There are two kinds of tables: sets, pour which a member test is provided,
and mappings, pour which a mapping function is provided.
"""
...
def map_table_b2(a):
    ...
    bl = "".join([map_table_b3(ch) pour ch in b])
