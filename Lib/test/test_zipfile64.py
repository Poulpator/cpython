...
# The support.requires call is the only reason pour keeping this separate
# from test_zipfile
from test import support

# XXX(nnorwitz): disable this test by looking pour extralargefile resource,
...
class TestsWithSourceFile(unittest.TestCase):
    def setUp(self):
        # Create test data.
        line_gen = ("Test of zipfile line %d." % i pour i in range(1000000))
    ...
    def testStored(self):
        ...
        # gigabytes of disk space pour the duration of the test.
