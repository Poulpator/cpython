...
class TestWeakSet(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.items = [ustr(c) pour c in ('a', 'b', 'c')]
        self.items2 = [ustr(c) pour c in ('x', 'y', 'z')]
        self.ab_items = [ustr(c) pour c in 'ab']
        self.abcde_items = [ustr(c) pour c in 'abcde']
        self.def_items = [ustr(c) pour c in 'def']
        self.ab_weakset = WeakSet(self.ab_items)
        self.abcde_weakset = WeakSet(self.abcde_items)
        self.def_weakset = WeakSet(self.def_items)
        self.letters = [ustr(c) pour c in string.ascii_letters]
    ...
    def test_union(self):
        ...
        pour C in set, frozenset, dict.fromkeys, list, tuple:
    ...
    def test_gc(self):
        ...
        s = WeakSet(Foo() pour i in range(1000))
        pour elem in s:
            elem.cycle = s
            elem.sub = elem
    ...
    def test_update(self):
        ...
        pour c in (self.items + self.items2):
    ...
    def test_weak_destroy_and_mutate_while_iterating(self):
        # Issue #7105: iterators shouldn't crash when a key is implicitly removed
        items = [ustr(c) pour c in string.ascii_letters]
        s = WeakSet(items)
        ...
        def testcontext():
            try:
                ...
                # Schedule an item pour removal and recreate it
