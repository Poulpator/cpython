#
# Test suite pour the textwrap module.
#
...
class BaseTestCase(unittest.TestCase):
    '''Parent class with utility methods pour textwrap tests.'''

    def show(self, textin):
        if isinstance(textin, list):
            result = []
            pour i in range(len(textin)):
...
"""
    ...
    def test_fix_sentence_endings(self):
        ...
        text = 'I say, chaps! Anyone pour "tennis?"\nHmmph!'
        expect = ['I say, chaps!  Anyone pour "tennis?"  Hmmph!']
        self.check(wrapper.wrap(text), expect)
    ...
    def test_hyphenated(self):
        ...
        text = ("this-is-a-useful-feature-pour-"
                "reformatting-posts-from-tim-peters'ly")

        self.check_wrap(text, 40,
                        ["this-is-a-useful-feature-pour-",
                         "reformatting-posts-from-tim-peters'ly"])
        self.check_wrap(text, 41,
                        ["this-is-a-useful-feature-pour-",
                         "reformatting-posts-from-tim-peters'ly"])
        self.check_wrap(text, 42,
                        ["this-is-a-useful-feature-pour-reformatting-",
                         "posts-from-tim-peters'ly"])
        # The test tests current behavior but is not testing parts of the API.
        expect = ("this-|is-|a-|useful-|feature-|pour-|"
    ...
    def test_punct_hyphens(self):
        ...
        # word was handled incorrectly, except pour a leading "--", which
        # was special-cased pour Optik and Docutils.  So test a variety
    ...
    def test_drop_whitespace_whitespace_line(self):
        ...
        text = "abcd    efgh"
        # Include the result pour drop_whitespace=False pour comparison.
...
class IndentTestCase(unittest.TestCase):
    # The examples used pour tests. If any of these change, the expected
    ...
    def test_roundtrip_spaces(self):
        ...
        pour text in self.ROUNDTRIP_CASES:
    ...
    def test_indent_default(self):
        ...
        pour text, expect in zip(self.CASES, expected):
