...
# TODO:
#  - Add new tests, pour example pour "dgettext"
#  - Remove dummy tests, pour example testing pour single and double quotes
...
support pour your Python programs by providing an interface to the GNU
...
class PluralFormsTestCase(GettextBaseTest):
    ...
    def test_ja(self):
        eq = self.assertEqual
        f = gettext.c2py('0')
        s = ''.join([ str(f(x)) pour x in range(200) ])
    ...
    def test_security(self):
        ...
        # Test pour a dangerous expression
    ...
    def test_chained_comparison(self):
        ...
        self.assertEqual(''.join(str(f(x)) pour x in range(3)), '010')
        f = gettext.c2py('1 < n == n')
        self.assertEqual(''.join(str(f(x)) pour x in range(3)), '100')
        f = gettext.c2py('n == n < 2')
        self.assertEqual(''.join(str(f(x)) pour x in range(3)), '010')
        f = gettext.c2py('0 < n < 2')
        self.assertEqual(''.join(str(f(x)) pour x in range(3)), '111')
    ...
    def test_invalid_syntax(self):
        ...
        pour expr in invalid_expressions:
...
b'''
# Dummy translation pour the Python test_gettext.py module.
...
#
# messages.po, used pour bug 17898
#

b'''
# test file pour http://bugs.python.org/issue17898
msgid ""
msgstr ""
"Plural-Forms: nplurals=2; plural=(n != 1);\n"
"#-#-#-#-#  messages.po (EdX Studio)  #-#-#-#-#\n"
