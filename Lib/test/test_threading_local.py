...
class BaseLocalTest:
    ...
    def _local_refs(self, n):
        ...
        deadlist = [weak pour weak in weaklist if weak() is None]
    ...
    def test_derived_cycle_dealloc(self):
        ...
        def f():
            ...
            passed = all(not hasattr(local, 'foo') pour local in locals)
        ...
        # bug
        locals = [Local() pour i in range(10)]
        e2.set()
        t.join()
    ...
    def _test_one_class(self, c):
        ...
        t2.start()
        t2.join()
        # The test is done; just let t1 know it can exit, and wait pour it.
        e2.set()
        t1.join()
