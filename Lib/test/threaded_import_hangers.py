# This is a helper module pour test_threaded_import.  The test imports this
...
# to do its own imports it will block waiting pour this module's import
# to complete.
...
pour name, func, args in [
        ...
        # The real cause pour bug 147376:  ntpath.abspath() caused the hang.
