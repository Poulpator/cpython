...
class CryptTestCase(unittest.TestCase):
    ...
    def test_sha2_rounds(self):
        pour method in (crypt.METHOD_SHA256, crypt.METHOD_SHA512):
            pour rounds in 1000, 10_000, 100_000:
