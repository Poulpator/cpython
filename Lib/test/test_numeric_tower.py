...
class HashTest(unittest.TestCase):
    def check_equal_hash(self, x, y):
        ...
        self.assertEqual(hash(x), hash(y),
                         "got different hashes pour {!r} and {!r}".format(x, y))
    ...
    def test_integers(self):
        ...
        # the current hash is based on reduction modulo 2**n-1 pour some
    ...
    def test_fractions(self):
        # check special case pour fractions where either the numerator
    ...
    def test_hash_normalization(self):
        # Test pour a bug encountered while changing long_hash.
        #
        # Given objects x and y, it should be possible pour y's
...
class ComparisonTest(unittest.TestCase):
    def test_mixed_comparisons(self):
        ...
        pour i, first in enumerate(test_values):
            pour second in test_values[i+1:]:
    ...
    def test_complex(self):
        ...
        pour v in 1, 1.0, F(1), D(1), complex(1):
            self.assertEqual(z, v)
            self.assertEqual(v, z)

        pour v in 2, 2.0, F(2), D(2), complex(2):
        ...
        pour v in (1, 1.0, F(1), D(1), complex(1),
            ...
            pour op in operator.le, operator.lt, operator.ge, operator.gt:
