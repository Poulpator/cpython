...
class ThreadedImportTests(unittest.TestCase):
    ...
    def check_parallel_module_init(self, mock_os):
        ...
        pour N in (20, 50) * 3:
            ...
            pour modname in ['random', 'modulefinder']:
                try:
    ...
    def test_parallel_path_hooks(self):
        ...
        # to path_hook().
        finder = Finder()
        # In order pour our path hook to be called at each import, we need
    ...
    def test_circular_imports(self):
        ...
        # circular imports, pour example:
        # - thread 1 imports A (grabbing the lock pour A) which imports B
        # - thread 2 imports B (grabbing the lock pour B) which imports A
        ...
        pour name, contents in circular_imports_modules.items():
