...
class BaseWinregTests(unittest.TestCase):
    ...
    def _write_test_data(self, root_key, subkeystr="sub_key",
                         CreateKey=CreateKey):
        # Set the default value pour this key.
        ...
        pour value_name, value_data, value_type in test_data:
    ...
    def _read_test_data(self, root_key, subkeystr="sub_key", OpenKey=OpenKey):
        # Check we can get default value pour this key.
...
class LocalWinregTests(BaseWinregTests):
    ...
    def test_setvalueex_value_range(self):
        # Test pour Issue #14420, accept proper ranges pour SetValueEx.
    ...
    def test_queryvalueex_return_value(self):
        # Test pour Issue #16759, return unsigned int from QueryValueEx.
    ...
    def test_setvalueex_crash_with_none_arg(self):
        # Test pour Issue #21151, segfault when None is passed to SetValueEx
        try:
            with CreateKey(HKEY_CURRENT_USER, test_key_name) as ck:
                self.assertNotEqual(ck.handle, 0)
                test_val = None
    ...
    def test_read_string_containing_null(self):
        # Test pour issue 25778: REG_SZ should not contain null characters
        try:
            with CreateKey(HKEY_CURRENT_USER, test_key_name) as ck:
                self.assertNotEqual(ck.handle, 0)
