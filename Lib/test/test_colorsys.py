...
class ColorsysTest(unittest.TestCase):
    ...
    def test_hsv_roundtrip(self):
        pour r in frange(0.0, 1.0, 0.2):
            pour g in frange(0.0, 1.0, 0.2):
                pour b in frange(0.0, 1.0, 0.2):
                    rgb = (r, g, b)
