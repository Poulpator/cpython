# Ridiculously simple test of the os.startfile function pour Windows.
#
# empty.vbs is an empty file (except pour a comment), which does
...
class TestCase(unittest.TestCase):
    ...
    def test_empty(self):
        ...
        # See http://bugs.python.org/issue15526 pour more details
