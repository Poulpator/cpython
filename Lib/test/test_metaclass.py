...
Use *args notation pour the bases.
...
Use **kwds notation pour the metaclass keyword.
...
Another way.
    ...
    Traceback (most recent call last):
    [...]
    TypeError: __build_class__() got multiple values pour keyword argument 'metaclass'
    >>>
