...
class PathHookTests:
    ...
    """Test the path hook pour extension modules."""
    # XXX Should it only succeed pour pre-existing directories?
    # XXX Should it only work pour directories containing an extension module?
