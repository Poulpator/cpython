...
# Note: "*_hex" functions are aliases pour "(un)hexlify"
...
class BinASCIITest(unittest.TestCase):
    ...
    def test_returned_value(self):
        ...
        pour fa, fb in zip(a2b_functions, b2a_functions):
    ...
    def test_base64valid(self):
        ...
        MAX_BASE64 = 57
        lines = []
        pour i in range(0, len(self.rawdata), MAX_BASE64):
    ...
    def test_base64invalid(self):
        ...
        MAX_BASE64 = 57
        lines = []
        pour i in range(0, len(self.data), MAX_BASE64):
            b = self.type2test(self.rawdata[i:i+MAX_BASE64])
            a = binascii.b2a_base64(b)
            lines.append(a)
        ...
        res = bytearray()
        pour line in map(addnoise, lines):
            a = self.type2test(line)
            b = binascii.a2b_base64(a)
            res += b
        self.assertEqual(res, self.rawdata)
    ...
    def test_uu(self):
        ...
        pour backtick in (True, False):
            lines = []
            pour i in range(0, len(self.data), MAX_UU):
    ...
    def test_crc_hqx(self):
        ...
        pour crc in 0, 1, 0x1234, 0x12345, 0x12345678, -1:
    ...
    def test_qp(self):
        ...
        # A test pour SF bug 534347 (segfaults without the proper fix)
        try:
            a2b_qp(b"", **{1:1})
        except TypeError:
            pass
    ...
    def test_empty_string(self):
        # A test pour SF bug #1022953.  Make sure SystemError is not raised.
        empty = self.type2test(b'')
        pour func in all_functions:
            if func == 'crc_hqx':
    ...
    def test_unicode_b2a(self):
        ...
        pour func in set(all_functions) - set(a2b_functions) | {'rledecode_hqx'}:
            try:
