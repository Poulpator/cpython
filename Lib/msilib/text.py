...
('AppSearch', 'Searching pour installed applications', 'Property: [1], Signature: [2]'),
('BindImage', 'Binding executables', 'File: [1]'),
('CCPSearch', 'Searching pour qualifying products', None),
...
('FindRelatedProducts', 'Searching pour related applications', 'Found application: [1]'),
...
('RMCCPSearch', 'Searching pour qualifying products', None),
...
('GenerateScript', 'Generating script operations pour action:', '[1]'),
...
('SelCostPending', 'Compiling cost pour this feature...'),
